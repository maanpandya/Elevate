...
def mission_setup(analyses, vehicle):
    ...
    mission.tag = 'Maneuvering Mission'
    ...
    segment.altitude_end = 16. * Units.m
    ...
    # segment attributes
    segment.altitude = 16 * Units.m
    segment.acceleration = 0.8 * Units['m/s/s']
    segment.air_speed_start = 5.0 * Units['m/s']
    segment.air_speed_end = 14. * Units['m/s']
    segment.true_course = 0.0 * Units.degrees
    ...
    # segment attributes
    segment.altitude = 16 * Units.m
    segment.acceleration = -0.7 * Units['m/s/s']
    segment.air_speed_start = 14. * Units['m/s']
    ...
    # segment attributes
    segment.altitude_start = 16 * Units.m
    ...
    segment.acceleration = 0.93 * Units['m/s/s']
    segment.air_speed_start = 2.5 * Units['m/s']
    segment.air_speed_end = 7. * Units['m/s']
    ...
    # segment attributes
    segment.altitude = 10 * Units.m
    segment.acceleration = 1.2 * Units['m/s/s']
    segment.air_speed_start = 7. * Units['m/s']
    segment.air_speed_end = 15. * Units['m/s']
    segment.true_course = 180. * Units.degrees
    ...
    segment.altitude = 10 * Units.m
    segment.acceleration = 1.2 * Units['m/s/s']
    segment.air_speed_start = 15. * Units['m/s']
    segment.air_speed_end = 20. * Units['m/s']
    segment.true_course = 180. * Units.degrees
    ...
    # segment attributes
    segment.altitude = 10 * Units.m
    segment.acceleration = -1.65 * Units['m/s/s']
    segment.air_speed_start = 20. * Units['m/s']
    segment.air_speed_end = 18. * Units['m/s']
    segment.true_course = 270. * Units.degrees
    ...
    # segment attributes
    segment.altitude = 10 * Units.m
    segment.acceleration = -1.7 * Units['m/s/s']
    segment.air_speed_start = 18. * Units['m/s']
    segment.air_speed_end = 8. * Units['m/s']
    segment.true_course = 180. * Units.degrees
    ...
    # segment attributes
    segment.altitude = 10 * Units.m
    segment.acceleration = -1.3 * Units['m/s/s']
    segment.air_speed_start = 8. * Units['m/s']
    segment.air_speed_end = 5.0 * Units['m/s']
    segment.true_course = 90. * Units.degrees
    ...
    # connect vehicle configuration
    segment.analyses.extend(analyses.no_alex)
    ...
    segment.air_speed_start = 14. * Units['m/s']
    segment.air_speed_end = 5.0 * Units['m/s']
    segment.true_course = 180.0 * Units.degrees
