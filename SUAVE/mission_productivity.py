...
# ----------------------------------------------------------------------
import SUAVE
from trunk.SUAVE.Methods.Aerodynamics.Common.Fidelity_Zero.Drag import parasite_drag_wing
...
def mission_setup(analyses, vehicle):
    ...
    mission.tag = 'Productivity Mission'
    ...
    segment.altitude_end = 300. * Units.m
    segment.climb_rate = 2.5 * Units.m / Units.s
    ...
    # segment attributes
    segment.altitude = 300. * Units.m
    segment.air_speed = 35. * Units.m / Units.s
    segment.distance = 500 * Units.m
    segment.true_course = 0. * Units.degrees
    ...
    # segment attributes
    segment.altitude_start = 300.
    segment.altitude_end = 0. * Units.m
    segment.descent_rate = 2.5 * Units.m / Units.s
    segment.true_course = 0. * Units.degrees
